...
# =============================================================================
# 2. FUNCIONES DE SEGMENTACION Y CONTEO
# =============================================================================
...
# =============================================================================
# 3. FUNCIONES DE CARACTERÍSTICAS GEOMETRICAS
# =============================================================================
...
if __name__ == "__main__":
    ...
    if img_color is None:
        print(f"Error: No se encontro '{ruta_imagen}'.")
    else:
        # Copias para dibujar
        ...
        # Dibujar rectangulos del conteo
        ...
        plt.title('3. Segmentacion (Otsu Binario)')
        plt.axis('off')
